...
public class URLHelper {
    public static final String base = "http://vtcsoft.fr/";
//    public static final String base = "https://dev.tranxit.co/";
    public static final String REDIRECT_URL = "http://vtcsoft.fr/" ;
    public static final String REDIRECT_PHONE = "+33988999852" ;
    public static final String REDIRECT_EMAIL = "info@callservices.net" ;
    public static final String EMAIL_SUBJECT = "VTC PRO - HELP";
    ...
    public static final String client_secret = "3nXJ0KxziMIXBBCfxvr8flEcDY8EXFbhZo5PBvjr";
//   public static final String client_secret = "yVnKClKDHPcDlqqO1V05RtDRdvtrVHfvjlfqliha";
    public static final String STRIPE_TOKEN = "pk_live_BRC1qqtBTAuLSm4mAuzcTdLw";
 //   public static final String client_secret = "sk_live_Ub2rEGCOXCr4Jeh2KaHbuIGt";
//    public static final String STRIPE_TOKEN = "pk_live_BRC1qqtBTAuLSm4mAuzcTdLw";
